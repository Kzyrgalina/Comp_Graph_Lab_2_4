...
static void RenderSceneCB()
{
    ...
    p.WorldPos(0.0f, 0.0f, 5.0f); //Задаем позицию
    p.SetPerspectiveProj(30.0f, WINDOW_WIDTH, WINDOW_HEIGHT, 1.0f, 100.0f); // Перспектива
...
static void CreateIndexBuffer() //,eath byltrcjd
{
    ...
    glGenBuffers(1, &IBO);
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, IBO); //функция для генерации объектов переменных типов
